...
function ImHeaderIcon() {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" height="24" viewBox="0 0 24 24" width="24">
      <path d="M0 0h24v24H0z" fill="#7a2829" />
      <path
    ...
    <Card className="w-full max-w-[270px]">
      <CardContent className="space-y-3 p-4">
        <div className="flex items-center gap-3">
          <div className="flex h-14 w-14 items-center justify-center rounded bg-[#7a2829] p-3">
            <ImHeaderIcon />
          </div>
          <span className="font-semibold">{t("ES_IM_HEADER_INCIDENTS")}</span>
        </div>
